#TODO: I did a lot of 'label stack' changes on local-path branch/worktree
#TODO: I also changed/creted priority-classes 
#TODO: namespace.yaml can have labels to put to every pod scheduled/born in its namepsace (pod template config)
# bash scripts 
