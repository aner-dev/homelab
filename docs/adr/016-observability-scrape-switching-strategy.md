...
* **Ingestion Filter Constraint:** Every distributed `VMServiceScrape` or `VMPodScrape` resource must include the mandatory tracking selector label: `athanor.io/scrape: "true"`.
